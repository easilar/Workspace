...
#'cut':"&&".join([lepSel['cut'],lepSel['veto'],lepSel['trigger'],ht_cut,st,njets_30_cut,jets_2_80,filters,nbjets_30_cut_zero]),\
'cut':"&&".join([ht_cut,OneLep,lepSel['cut'],lepSel['veto'],lep_hard,lepSel['trigger'],njets_30_cut,jets_2_80,st,filters,nbjets_30_cut_zero]),\
...
'bkgcut':"&&".join([ht_cut,OneLep,lepSel['cut'],lepSel['veto'],lep_hard,njets_30_cut,jets_2_80,st,nbjets_30_cut_zero]),\
...
for p in plots:
  ...
  ##latex.DrawLatex(0.6,0.5,"#bf{MC scale=0.78}")
  Pad1.RedrawAxis()
  can.cd()
