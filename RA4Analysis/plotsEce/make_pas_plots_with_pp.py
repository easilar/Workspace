...
#  {'cut':OneMu , 'veto':OneMu_lepveto, 'label':'_mu_', 'str':'1 $\\mu$' , 'trigger': '(HLT_MuHT350MET70 || HLT_Mu50NoIso)'},\
  {'cut':OneMu , 'veto':OneMu_lepveto, 'label':'_mu_', 'str':'1 $\\mu$' , 'trigger': '(HLT_MuHT350)'},\
  #{'cut':OneE ,  'veto':OneE_lepveto,  'label':'_ele_','str':'1 $e$', 'trigger': '(HLT_EleHT350MET70 || HLT_ElNoIso)'},\
####  {'cut':OneE ,  'veto':OneE_lepveto,  'label':'_ele_','str':'1 $e$', 'trigger': '(HLT_EleHT350)'},\
...
path = "/afs/hephy.at/user/e/easilar/www/data/Run2015D/newTrigger/zeroB/"+lepSel['label']+"/"
...
{'sample':'TTVH',          "name":TTVH_25ns ,'tex':'t#bar{t}+W/Z/H','color':ROOT.kOrange-3}, 
...
{"sample":"ttJets",       "name":TTJets_LO_25ns, "tex":"ttbar + jets",'color':ROOT.kBlue-4},
]
