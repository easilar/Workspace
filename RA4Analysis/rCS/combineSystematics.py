...
multisignalRegions = signalRegions2016_HT5001000_onebyone
pickleDir =  '/afs/hephy.at/data/easilar01/Results2016/Prediction_Spring16_templates_SR_ICHEP2016_v1_lep_MC_SF_40/'
saveDir = pickleDir
bins = 20
i= 1
res_final = {}
for signalRegions in multisignalRegions :

  
  #rcs     = pickle.load(file(pickleDir+'singleLeptonic_Spring16_Aggregate40_ht1000_'+str(i-1)+'_estimationResults_pkl_kappa_corrected')) 
  #rcs     = pickle.load(file(pickleDir+'singleLeptonic_Spring16_Aggregate40_ht1000_new_'+str(i-1)+'_estimationResults_pkl_kappa_corrected')) 
  rcs     = pickle.load(file(pickleDir+'singleLeptonic_Spring16_Aggregate40_ht5001000_'+str(i-1)+'_estimationResults_pkl_kappa_corrected')) 
  dataResult = rcs
  ...
  #pickleDir =  '/afs/hephy.at/data/easilar01/Results2016/Prediction_Spring16_templates_SR_Moriond2017_v1_lep_MC_SF_40/'
  ...
  #rcs     = pickle.load(file(pickleDir+'singleLeptonic_Spring16__0_estimationResults_pkl_kappa_corrected'))
  if validation:
  ...
  for injb,srNJet in enumerate(sorted(signalRegions)):
    if not srNJet in res_final.keys(): res_final[srNJet] = {}
    for stb in sorted(signalRegions[srNJet]):
      if not stb in res_final[srNJet].keys(): res_final[srNJet][stb] = {}
      for htb in sorted(signalRegions[srNJet][stb]):
        ...
        #rcs     = pickle.load(file(pickleDir+'singleLeptonic_Spring16_ICHEP40_'+str(i-1)+'_estimationResults_pkl_kappa_corrected')) 
        ...
        print "W errors : " , rcs[srNJet][stb][htb]['W_pred_errs']['const_vs_slope'] , rcs[srNJet][stb][htb]['W_pred']
        ...
        res_final[srNJet][stb][htb] = rcs[srNJet][stb][htb]
...
savePickle = True
if savePickle:
  pickle.dump(res_final, file(saveDir+'resultsFinal_withSystematics_5001000_pkl','w'))
  print "pickle Written :" , saveDir+'resultsFinal_withSystematics_5001000_pkl'
else:
