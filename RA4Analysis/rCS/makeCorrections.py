...
for weight_dict in weights:
  ...
  weight_str, weight_err_str = makeWeight(lumi, sampleLumi=sampleLumi,  in_weight = weight_dict['var'])

  prefix = 'singleLeptonic_Spring15_'
  presel = "singleLeptonic&&nLooseHardLeptons==1&&nTightHardLeptons==1&&nLooseSoftLeptons==0&&nLooseSoftLeptons==0&&Jet_pt[1]>80"
  ...
  print "Written:" , pickleDir+prefix+'_estimationResults_pkl_kappa_corrected'
