...
for srNJet in signalRegions:
  for stb in signalRegions[srNJet]:
    for htb in signalRegions[srNJet][stb]:
      ...
      latex.DrawLatex(0.6,0.9,ht)
      latex.DrawLatex(0.6,0.85,lt)
      ...
      latex.DrawLatex(0.3,0.8,"Single Muon")
      cb.Draw()
      cb.SaveAs('~/www/Spring15/25ns/rCS_Plots/ttJetsCombined_rCS_LT'+str(stb[0])+str(stb[1])+'_HT'+str(htb[0])+str(htb[1])+'_nJET'+str(srNJet[0])+str(srNJet[1])+'.png')
      cb.SaveAs('~/www/Spring15/25ns/rCS_Plots/ttJetsCombined_rCS_LT'+str(stb[0])+str(stb[1])+'_HT'+str(htb[0])+str(htb[1])+'_nJET'+str(srNJet[0])+str(srNJet[1])+'.pdf')
      cb.SaveAs('~/www/Spring15/25ns/rCS_Plots/ttJetsCombined_rCS_LT'+str(stb[0])+str(stb[1])+'_HT'+str(htb[0])+str(htb[1])+'_nJET'+str(srNJet[0])+str(srNJet[1])+'.root')
